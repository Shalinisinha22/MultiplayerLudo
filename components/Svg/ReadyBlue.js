...
import { B1, B8, B9, FINISHED, G1, G8, G9, R1, R8, R9, Y1, Y8, Y9 } from "../../src/util/Constants";
import DefaultCell from "../../src/util/DefaultCell";
...
//   props.positions === R1 ||  props.positions === R9 ||  props.positions === Y1 ||  props.positions === Y9 ||  props.positions === G1 ||  props.positions === G9 ||  props.positions === B1 ||  props.positions === B9 ?
DefaultCell(props.positions)?

  <Animatable.View style={[{height:20,width:20,position:"absolute", top:top, right:right},]} 
